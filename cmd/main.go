...
import (
	...
	"github.com/kkato/password-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f54b97e5.example.com",
	...
	if err := (&controller.PasswordReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "Password")
		os.Exit(1)
	}
