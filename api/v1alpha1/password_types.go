...
type PasswordStatus struct {
	...
	// conditions represent the current state of the Password resource.
...
type Password struct {
	...
	// spec defines the desired state of Password
	// +required
	Spec PasswordSpec `json:"spec"`

	// status defines the observed state of Password
	// +optional
	Status PasswordStatus `json:"status,omitzero"`
}
