...
// +kubebuilder:rbac:groups=secret.kkato.app,resources=passwords,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=secret.kkato.app,resources=passwords/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=secret.kkato.app,resources=passwords/finalizers,verbs=update
